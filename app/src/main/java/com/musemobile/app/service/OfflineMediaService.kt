...
import com.musemobile.app.ui.OfflineActivity
import java.io.File
...
class OfflineMediaService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "musemobile_offline_playback"
        private const val NOTIFICATION_ID = 2

        const val ACTION_PLAY_PAUSE = "com.musemobile.app.offline.ACTION_PLAY_PAUSE"
        const val ACTION_NEXT = "com.musemobile.app.offline.ACTION_NEXT"
        const val ACTION_PREV = "com.musemobile.app.offline.ACTION_PREV"
        const val ACTION_STOP = "com.musemobile.app.offline.ACTION_STOP"
    ...
    private var currentAlbum = "MuseMobile"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (intent?.hasExtra("title") == true) {
            ...
            currentAlbum = intent.getStringExtra("album")?.ifBlank { "MuseMobile" } ?: "MuseMobile"
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val channel = NotificationChannel(
                ...
                description = "MuseMobile offline playback controls"
                setShowBadge(false)
    ...
    private fun setupMediaSession() {
        mediaSession = MediaSessionCompat(this, "MuseMobileOfflineSession").apply {
            setFlags(
    ...
    fun updateTrack(title: String, artist: String, album: String, coverFile: File?, duration: Long) {
        ...
        currentAlbum = album.ifBlank { "MuseMobile" }
