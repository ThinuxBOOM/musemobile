...
class DownloadService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "musemobile_downloads"
        private const val NOTIF_ID = 3

        const val ACTION_SKIP = "com.musemobile.app.download.ACTION_SKIP"
        const val ACTION_CANCEL = "com.musemobile.app.download.ACTION_CANCEL"
    }
    ...
    private fun createChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val channel = NotificationChannel(
                ...
                description = "MuseMobile track downloads"
                setShowBadge(false)
    ...
    private fun buildNotification(): Notification {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("MuseMobile Download")
        ...
        try {
            builder.color = com.musemobile.app.webview.helpers.AccentTheme
