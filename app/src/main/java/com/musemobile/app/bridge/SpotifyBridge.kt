package com.musemobile.app.bridge
...
import com.musemobile.app.webview.helpers.AdIdStore
...
class SpotifyBridge(activityRef: WeakReference<Activity>) {
    ...
    fun loginDetected() {
        ...
        activity.getSharedPreferences("musemobile_prefs", Activity.MODE_PRIVATE)
            .edit()
    ...
    fun dbg(level: String?, msg: String?) {
        val m = msg ?: return
        val activity = activityRef.get() ?: return
        if (!activity.getSharedPreferences("musemobile_prefs", Activity.MODE_PRIVATE)
        ...
        com.musemobile.app.util.DebugLogStore.log(tag, m)
    }
