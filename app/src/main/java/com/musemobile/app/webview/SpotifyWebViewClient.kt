package com.musemobile.app.webview
...
import com.musemobile.app.webview.helpers.*
import com.musemobile.app.webview.injections.*
...
class SpotifyWebViewClient(
    ...
    override fun onPageFinished(view: WebView?, url: String?) {
        ...
        val loggedIn = view.context.getSharedPreferences("musemobile_prefs", 0)
        ...
        view.evaluateJavascript(LogoutCheck.CONTENT) { result ->
            if (result == "\"out\"") {
                view.context.getSharedPreferences("musemobile_prefs", 0)
    ...
    override fun onPageStarted(view: WebView?, url: String?, favicon: Bitmap?) {
        ...
        val prefs = view?.context?.getSharedPreferences("musemobile_prefs", 0)
        ...
        view?.evaluateJavascript("window.__musemobileUseProxy=$useProxy;", null)
        ...
        view?.evaluateJavascript(Adblockify.CONTENT, null)
    ...
    override fun shouldInterceptRequest(
        ...
        val useProxy = view.context.getSharedPreferences("musemobile_prefs", 0)
    ...
    private fun injectPlayerControl(view: WebView) {
        ...
        val js = buildString {
            ...
            append("window.__musemobileUseProxy=$useProxy;\n")
            ...
            if (playerMode == "musemobile") {
                append(MuseMobilePlayer.CONTENT)
            }
        }
    ...
    private fun switchPlayerMode(view: WebView, mode: String) {
        ...
        if (normalized == "original") {
            ...
            view.evaluateJavascript("if(typeof initMuseMobilePlayer!=='function'){" + MuseMobilePlayer.CONTENT + "}", null)
            val js = """
                (function(){
                    ...
                    else if(typeof initMuseMobilePlayer==='function'){initMuseMobilePlayer();}
                })();
            """.trimIndent()
            view.evaluateJavascript(js, null)
        }
