...
/**
 * MuseMobile - Lyrics Style Engine.
 *
 * Injects a dedicated <style id="musemobile-lyrics-style"> element. It does
 * NOT touch 'musemobile-custom-css' (owned by the CustomCss setting), so the
...
object LyricsTheme {
    ...
    private const val STYLE_ID = "musemobile-lyrics-style"
