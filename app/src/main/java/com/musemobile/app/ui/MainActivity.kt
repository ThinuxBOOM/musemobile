...
import com.musemobile.app.service.MediaNotificationService
import com.musemobile.app.ui.components.SettingsDrawer
import com.musemobile.app.ui.theme.SpotifyTheme
import com.musemobile.app.util.UpdateChecker
import com.musemobile.app.webview.SpotifyWebChromeClient
import com.musemobile.app.webview.SpotifyWebViewClient
import com.musemobile.app.webview.helpers.DevLogPrelude
import com.musemobile.app.webview.helpers.LyricsTheme
import com.musemobile.app.webview.helpers.buildAmoledJs
import com.musemobile.app.webview.helpers.buildCustomCssJs
import com.musemobile.app.webview.injections.LogoutCheck
...
import com.musemobile.app.ui.components.ErrorScreen
import com.musemobile.app.ui.components.mapWebViewError
...
class MainActivity : ComponentActivity() {
                        ...
                        Box(
                            ...
                            webViewError.value?.let { (code, desc) ->
                                com.musemobile.app.ui.components.ErrorScreen(
                                    errorType = com.musemobile.app.ui.components.mapWebViewError(code),
                                    errorCode = code,
    ...
    private fun startDownloadService() {
        runCatching {
            ContextCompat.startForegroundService(
                this, Intent(this, com.musemobile.app.service.DownloadService::class.java)
            )
        }
    }
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        val loggedIn = getSharedPreferences("musemobile_prefs", MODE_PRIVATE)
